...
export const getParkingReviews = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const reviews = await reviewService.getParkingReviews(parkingId as string);

    res
      .status(200)
      .json(
        new ApiResponse(200, reviews, "Parking reviews fetched successfully."),
      );
  },
);
...
export const getOwnerReviews = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const reviews = await reviewService.getOwnerReviews(ownerId as string);

    res
      .status(200)
      .json(
        new ApiResponse(200, reviews, "Owner reviews fetched successfully."),
      );
  },
);
...
export const deleteReview = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const review = await reviewService.deleteReview(userId, id as string);
