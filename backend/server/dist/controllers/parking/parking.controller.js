...
export const getParking = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, parking, "Parking fetched successfully."));
});
export const updateParking = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, parking, "Parking updated successfully."));
});
export const deleteParking = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, null, "Parking deactivated successfully."));
});
