...
export const registerSchema = z
    ...
    firstName: z
        ...
        .regex(/^[A-Za-z]+(?:[ '-][A-Za-z]+)*$/, "First name can contain letters only."),
    lastName: z
        .string()
        .trim()
        .min(3, "Last name must be at least 3 characters.")
        .max(30, "Last name is too long.")
        .regex(/^[A-Za-z]+(?:[ '-][A-Za-z]+)*$/, "Last name can contain letters only."),
    ...
    password: z
        ...
        .max(AUTH.PASSWORD.MAX_LENGTH, `Password cannot exceed ${AUTH.PASSWORD.MAX_LENGTH} characters`)
