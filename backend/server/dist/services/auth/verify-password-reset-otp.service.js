...
export const verifyPasswordResetOtp = async ({ email, otp, }) => {
    ...
    if (user.passwordResetOtpExpiresAt.getTime() <=
        Date.now()) {
    ...
    if (user.passwordResetOtpAttempts >=
        maxAttempts) {
     ...
     * OTP is correct.
     *
     * We don't create or return a resetToken.
     * Instead, we mark the account as OTP-verified.
     *
     * This authorization is valid for 10 minutes.
     */
