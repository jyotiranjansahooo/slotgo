class PricingService {
    ...
    getHourlyRate(parking, vehicleType) {
        let rate = 0;
        switch (vehicleType) {
            case "twoWheeler":
    ...
    // OVERTIME PRICING
    calculateOvertime(parking, vehicleType, bookedEndTime, checkoutTime) {
        ...
        // ==========================================================
        const overtimeParkingAmount = Number((hourlyRate * overtimeHours).toFixed(2));
        // ==========================================================
        // OVERTIME FINE
        //
        ...
        // ==========================================================
        const overtimeTotal = Number((overtimeParkingAmount + overtimeFine).toFixed(2));
        // ==========================================================
        // OWNER COMMISSION
        //
        ...
        // OWNER RECEIVES
        // ==========================================================
        const ownerReceives = Number((overtimeParkingAmount - ownerCommission).toFixed(2));
        return {
            overtimeMinutes,
            overtimeHours,
