...
router.post("/", uploadParkingImages.array("images", 5), parseParkingFormData, validate(createParkingSchema), createParking);
router.get("/", getMyParkings);
router.get("/:id", getParking);
router.patch("/:id", uploadParkingImages.array("images", 5), parseParkingFormData, validate(updateParkingSchema), updateParking);
