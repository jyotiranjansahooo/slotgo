...
function Payment() {
  ...
  return (
    <main className="min-h-screen mt-16 bg-slate-950 px-4 py-10 text-white">
      <Script
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
          ...
          <div className="space-y-4 py-5">
            ...
            {booking.discountAmount > 0 && (
              <SummaryRow
                label="Discount"
                value={`-${formatMoney(booking.discountAmount, "INR")}`}
              />
            )}
          ...
          >
            {verifyMutation.isPending
              ? "Verifying Payment..."
              : `Pay ${formatMoney(booking.driverPays, "INR")}`}
          </button>
